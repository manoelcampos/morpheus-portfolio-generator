= Portfolio Analysis in Java

Sample projects for generation and analysis of financial portfolios applying the
...
The image below shows an example of the graph generate for groups of
